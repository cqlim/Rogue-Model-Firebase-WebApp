      ...
      .then((u) => {
        firestoreDB
          ...
          .add({
            ...
            managerType: document.querySelector(
              'input[name="managerType"]:checked'
            ).value,
          ...
          .then((docRef) => {
            ...
            // document.getElementById("managerType").checked = false;
          })
          .catch((error) => {
            console.log(error);
            return this.setState({ status: error });
      ...
      <div>
        ...
        <Grid.Column width={4}>
          <Form error={error} onSubmit={this.onSubmit}>
            <Header as="h2">Create manager account</Header>
            {this.state.status && (
